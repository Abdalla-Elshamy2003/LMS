...
class R2VideoStoreTest {
    final R2VideoStore store = new R2VideoStore("https://acct123.r2.cloudflarestorage.com", "madarik-videos", "AKIDEXAMPLE", "SECRETEXAMPLE");
    ...
    @Test void partUploadUrlIsPathStyleAndSignedWithoutChecksums() {
        ...
        assertThat(url.getPath()).isEqualTo("/madarik-videos/t5/videos/0b6f/original.mp4");
    ...
    @Test void playbackLinkIsShortLived() {
        ...
        assertThat(url.getPath()).isEqualTo("/madarik-videos/t5/videos/0b6f/hls/v0/seg_001.ts");
