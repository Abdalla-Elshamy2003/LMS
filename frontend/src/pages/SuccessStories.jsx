...
const SCENARIOS = [
  {
    ...
    outcome: 'مع دروس، بيسجّل حضوره بـ QR في ثواني، ويولّد أسئلة امتحان بالذكاء الاصطناعي في دقايق، وأولياء الأمور بياخدوا تحديث تلقائي على الواتساب — من غير ما يبعت رسالة واحدة بنفسه.',
  },
  {
...
export default function SuccessStories() {
  return (
    <div className="min-h-screen overflow-x-clip bg-[#f6fbff] text-ink-800">
      <MarketingNav solid />
      <PageHero badge="لمين دروس؟" title="مصمّمة لكل" highlight="أنواع المؤسسات التعليمية"
        subtitle="من المدرس المستقل للجامعة الكبيرة — شوف إزاي دروس بتحل تحديات كل نوع مؤسسة." />
        ...
        {SCENARIOS.map((s, i) => (
          <motion.div key={s.persona} initial={{ opacity: 0, y: 24 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: '-60px' }}
            ...
            <div className="grid gap-6 p-6 sm:grid-cols-2 sm:p-8">
              ...
              <div>
                <span className="chip bg-emerald-50 text-emerald-700"><CheckCircle2 size={13} /> الحل مع دروس</span>
